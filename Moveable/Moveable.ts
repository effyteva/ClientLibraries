module Teva {
    export interface MoveableOptions {
        ...
        Interval?: number;
        Threshold?: number;
        PreventOverClass?: any;
        OnStart?: any;
        OnStop?: any;
    }

    export class Moveable {
        static Enable(Elements, Options: MoveableOptions) {
        ...
        static InnerEnable(Element, Options: MoveableOptions) {
            ...
            Handle.on("mousedown", function (e) {
                ...
                if (Options.Helper != null) {
                    ...
                    //Dragged.addClass(HelperClass).addClass("tom-dashboards-backcolor-white");
                }
        ...
        private static GetDefaults(): MoveableOptions {
        ...
        private static IsOverElement(Options: MoveableOptions, CurrentElement): boolean {
        ...
        private static GetRounding(Options: MoveableOptions, Number: number): number {
